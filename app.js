...
function animate() {
    ...
    const orbitDist = window.innerWidth <= 900 ? (window.innerWidth <= 480 ? '320%' : '340%') : '380%';
    modelViewer.cameraOrbit = `${(currentMouse.x * 40) + switchSpin}deg ${90 + (currentMouse.y * 20)}deg ${orbitDist}`;
